...
// Self-provisioning shared by the Cardputer Adv, T-Deck and T-Pager dual-boot builds.
  ...
  #elif BOARD_MODEL == BOARD_TPAGER
    #define SELF_PROVISION_PRODUCT PRODUCT_TPAGER
    #define SELF_PROVISION_MODEL   MODEL_ED
  #else
